...
```
wget -O tcpx.sh "https://github.com/fei5seven/Linux-NetSpeed-new/raw/master/tcpx.sh" && chmod +x tcpx.sh && ./tcpx.sh
```

卸载内核版本
```
wget -O tcp.sh "https://github.com/fei5seven/Linux-NetSpeed-new/raw/master/tcp.sh" && chmod +x tcp.sh && ./tcp.sh
```
关联action自动编译内核
